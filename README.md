...
log_level: DEBUG
wave_product: wave       # or wave_aberr
...
| File | Content |
| --- | --- |
| `flat.npz` | bad map, flat map, profile map, trace data, and QC summary |
| `wave.npz` | wavelength map and QC summary |
| `wave_aberr.npz` | aberration-corrected wavelength map and QC summary |
